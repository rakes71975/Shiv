...
module.exports = {
  ...
  onMessage: async function({ api, event, Threads, config }) {
    ...
    const botWords = ['bot', 'goi', 'baby', 'raza'];
...
Bot will send random sticker when someone says "bot", "goi", "baby", or "raza".
...
- botsticker send (to send a sticker now)`);
    ...
    if (action === 'on' || action === 'enable') {
      ...
      return send.reply('Bot sticker enabled.\n\nBot will react with stickers when someone says "bot", "goi", "baby", or "raza".');
    }
